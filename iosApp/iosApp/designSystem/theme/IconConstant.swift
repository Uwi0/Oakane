...
struct IconConstant {
    ...
    static let MoneyDollarCircleFill = "money.dollar.circle.fill"
    
    // gas
    static let FuelpumpFill = "fuelpump.fill"
    
    // insurance
    static let ParkingFill = "parkingsign.circle.fill"
    
    // public transportation
    static let BusFill = "bus.fill"
    static let TramFill = "tram.fill"
    static let TrainSideFill = "train.side.fill"
    ...
    static let TakeoutbagFill = "takeoutbag.fill"
    ...
    static let PersonFillVideo = "person.fill.video"
    
    // concerts
    static let MusicNote = "music.note"
    static let GuitarFill = "guitar.fill"
    ...
    // insurance premiums
    static let ShieldCheckerboard = "shield.checkerboard"
    static let CreditCardFill = "creditcard.fill"
    ...
    static let PresentTurnedToFront = "present.turned.to.front"
    
    // clothes
    static let Suit = "suit"
    static let DressFill = "dress.fill"
